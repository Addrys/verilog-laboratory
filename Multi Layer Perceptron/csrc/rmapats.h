...
typedef struct _RmaMultiInputTable {
    ...
    UB  * I980;
    UB  * I981;
    struct _RmaMultiInputTable * I954;
    struct _RmaMultiInputTable * I983;
} RmaMultiInputTable;
...
typedef struct {
    ...
    U  I1072;
    U  I1073;
    HsimSignalMonitor  * I1074;
    RP  I1075;
    RmaTimeStamp64  I1076;
    U  I1077;
...
typedef struct {
    ...
    US  I1172;
    RP  I1173;
    RemoteDbsedLoad   I1174[1];
} RmaRtlEdgeBlock;
typedef struct TableAssign_ {
    struct TableAssign_ * I954;
...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I954;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    struct TableAssignLayoutOnClkOpt_ * I954;
    ...
    U  I1189 :1;
    U  I978 :9;
    RmaSeqPrimOutputOnClkOpt  I1191;
    RmaSeqPrimOutputEblkData  I1195;
...
struct dummyq_struct {
    ...
    struct futq * I1302;
    struct futq * I1303;
    struct sched_table * I1304;
    struct futq_info * I1306;
...
void  rmaPropagate3_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate4_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate5_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate6_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate7_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate8_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate9_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate11_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
...
void  rmaPropagate12_f_simv_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1416, U  did);
